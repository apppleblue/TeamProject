...
<div class="container-fluid">
    ...
    <input id="canvasID" type="number" value="">
    <input id="Save" type="button" value="Save" onclick="g();getcanvas(function(result){
        alert(result);
    });" />
	<input id="Load" type="button" value="Load" onclick="load();"/>
<script>
